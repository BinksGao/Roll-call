...
public class StuInfoQuery extends Activity {
private Button queryDB;
private ListView listview3;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_stu_info_query);
		setTitle("学生信息");
...
public void queryDB(View v){
		...
		if(cursor.getCount()==0){
			Toast.makeText(StuInfoQuery.this, "学生数据库无记录", 0).show();
		}else{
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		SimpleAdapter adapter = new SimpleAdapter(StuInfoQuery.this, list, R.layout.listitem_device,
